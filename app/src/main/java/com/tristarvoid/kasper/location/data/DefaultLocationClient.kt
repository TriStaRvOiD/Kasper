...
import com.tristarvoid.kasper.location.utils.hasLocationPermission
...
class DefaultLocationClient(
    ...
    override fun getLocationUpdates(interval: Long, priority: Int): Flow<Location> {
        return callbackFlow {
            ...
            val request = LocationRequest.Builder(interval).setMaxUpdateDelayMillis(interval)
