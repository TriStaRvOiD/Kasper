...
val Context.stepStatusDataStore: DataStore<Preferences> by preferencesDataStore(name = "step_status_pref")

class StepServiceStatusDataStoreRepository(context: Context) {

    private object PreferencesKey {
        val statusKey = booleanPreferencesKey(name = "step_service_status")
    }

    private val statusDataStore = context.stepStatusDataStore
